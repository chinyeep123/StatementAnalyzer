...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        ...
        <Actions 
            ...
            @search="search"
            @show-stat="toggleStat('stat')"
            @show-create="toggleStatement({id: statementModal, data: {}})"
        >
            <template #extra>
                <button class="btn btn-lg btn-success" @click.stop="toggleTag(tagListingModal)" data-project-progress="0">Tag</button>
            </template>
        </Actions>
        <!-- action buttons -->
    ...
    <div class="row">
        <div class="col-12">
            ...
            class="text-center"
            />
            <div v-else :class="`card count-${statements.length}`" :id="this.settings.module + '-table-wrapper'">
                <div class="card-body">
                        ...
                        <table :id="this.settings.module + '-list-table'" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                            <thead>
                                <tr>
                                    ...
                                    <th :class="this.settings.module + '_col_debit_currency'"><a id="sort_debit_currency" href="javascript:void(0)" @click.prevent="sortBy('debit_currency')">Currency<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                                    </th>
                                    <th :class="this.settings.module + '_col_debit'"><a id="sort_debit" href="javascript:void(0)" @click.prevent="sortBy('debit')">Money In<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                                    </th>
                                    <th :class="this.settings.module + '_col_credit_currency'"><a id="sort_credit_currency" href="javascript:void(0)" @click.prevent="sortBy('credit_currency')">Currency<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                                    </th>
                                    <th :class="this.settings.module + '_col_credit'"><a id="sort_credit" href="javascript:void(0)" @click.prevent="sortBy('credit')">Money Out<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                                    </th>
        ...
        <template #panel-body>
            ...
            <div class="filter-block">
                <div class="fields">
                    <div class="row">
                        <div class="col-md-12">
                            <input class="with-gap checkbox-col-blue create-modal-selector"
                                name="without_tag" type="checkbox" id="without_tag"
                                v-model="filter_params.without_tag"
                            >
                            <label for="without_tag"><span
                                    class="x-label-text">Without Tag</span>
                            </label>
                        </div>
                    </div>
                </div>
    ...
    :show="showStatement(statementModal)" 
    @close="toggleStatement({id: statementModal, data: {}})"
    />

    <TagTable
    :show="showTag(tagListingModal)" 
    @close="toggleTag(tagListingModal)"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                activeStat:  (!_.isEmpty(localStorage.getItem('show-stat')) && localStorage.getItem('show-stat') != '0')? localStorage.getItem('show-stat') : 0,
        ...
        methods: {
            ...
            showStat: function(id) {
                let stat_session = localStorage.getItem('show-stat');
                return this.activeStat === stat_session 
            },
            toggleStat: function (id) {
