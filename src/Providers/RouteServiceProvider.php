...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Ant\StatementAnalyzer\Http\Controllers';
    ...
    protected function mapWebRoutes()
    {
        Route::group([
            ...
            require base_path('modules/StatementAnalyzer/routes/web.php');
        });
    }
    ...
    protected function mapApiRoutes()
    {
        Route::group([
            ...
            require base_path('modules/StatementAnalyzer/routes/api.php');
        });
    }

    protected function mapDataTableRoutes() {
        Route::group($this->routeDatatableConfiguration(), function () {
            require base_path('modules/StatementAnalyzer/routes/datatable.php');
        });
    }
